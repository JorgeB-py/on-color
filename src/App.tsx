...
export default function App() {
  ...
  const [username, setUsername] = useState('Jorge Bustamante')
                ...
                {activeTab === 'home' && (
                  <>
                    <section className="bg-cyan-50 p-4">
                      ...
                      <div className="bg-gray-300 h-32 flex items-center justify-center overflow-hidden">
                        <img 
                          src='https://www.electroluxprofessional.com/es/wp-content/uploads/2024/05/World-Water-Day_966x752_.webp' 
                          alt="Día Mundial del Agua"
                  ...
                  <section className="p-4">
                    ...
                    <ul className="space-y-4">
                      <li className="bg-cyan-50 p-3 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Puedes ahorrar hasta 12 litros (60 vasos) por minuto.</p>
                      </li>
                      <li className="bg-cyan-50 p-3 rounded-lg">
                      ...
                      <li className="bg-cyan-50 p-3 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Una fuga puede desperdiciar hasta 30 litros (150 vasos) al día.</p>
                      </li>
                    </ul>
                  </section>
                )}
                  ...
                  <section className="p-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-cyan-50 p-3 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Ahorra 100 vasos de agua más para obtener un descuento del 15% en tu factura</p>
